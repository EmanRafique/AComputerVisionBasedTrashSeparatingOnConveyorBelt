...
const ArchieveEmployee = ({ navigation }) => {
    ...
    const handleArchive = async () => {
        ...
        try {
            const response = await axios.post(`${ApiURL}/archiveEmployee`, {
                name: userName,
                email: email,
            ...
            console.log('Error:', error); // Log the full error object for inspection
    ...
    return (
        ...
        >
            ...
            {/* Archived Button */}
            <MyBtn title="Archive" onPress={handleArchive} />
        </ScrollView>
    );
};
export default ArchieveEmployee;
